...
#### Set the working directory (directory removed for publication)
setwd("..")
...
(9/5768)*100
rm(rep_data, rep_data_dups, rep_data_dups_complete_phenos, rep_data_dups_complete_units, rep_across_studies, rep_across_studies_check)
