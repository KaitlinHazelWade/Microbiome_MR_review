...
## Created: 03/11/2023
## By: Charlie Hatcher and Kaitlin Wade
#########################################################################################
rm(list=ls())
...
## Set the working directory (working directory removed for publishing)
setwd("..")
...
data_kaitlin <- read_excel("./Backup/DataExtraction/final_data_extraction_020225.xlsx", sheet="Kaitlin")
...
data_charlie <- read_excel("./Backup/DataExtraction/final_data_extraction_020225.xlsx", sheet="Charlies")
...
## Check that there are still only 66 studies - 48083 observations
